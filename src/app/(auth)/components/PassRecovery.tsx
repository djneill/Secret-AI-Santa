...
export default function PasswordRecovery() {
    ...
    const handleRecovery = async (e: FormEvent<HTMLFormElement>) => {
        e.preventDefault();
        try {
            const redirectUrl = 'https://secret-ai-santa.vercel.app/password-reset';
    ...
    return (
        <div>
            <form onSubmit={handleRecovery} className='w-80 sm:w-[560px] flex flex-col gap-4 ~px-5/8 ~py-6/8 p- rounded-lg bg-white text-black justify-center'>
                <h1 className='text-lg text-center text-black pb-8'>Password Recovery</h1>
                <div>
                ...
                <div className="flex">
                    ...
                    <Link className='text-preset-4-bold ml-2 underline text-blue-500' href='/signin'>
                        Login
                    </Link>
                </div>
